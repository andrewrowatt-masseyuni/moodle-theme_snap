...
$string['multilangsectionnames'] = 'Use multi-language section names';
$string['multilangsectionnames_help'] = 'This setting controls whether multi-language filtering is applied to section names. When set to "Auto", the theme will automatically detect and apply filtering when multi-language tags are found in section names.';
$string['multilangsectionnames_auto'] = 'Auto';
$string['multilangsectionnames_yes'] = 'Yes';
$string['multilangsectionnames_no'] = 'No';
